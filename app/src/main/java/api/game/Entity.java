...
public abstract class Entity implements Comparable<Entity> {
    ...
    /**
     * Define o índice da posição da entidade.
     *
     * @param index O novo índice da posição da entidade.
     */
    ...
    /**
     * Retorna uma representação em formato de string do índice da posição da
     * entidade.
     *
     * @return Uma string representando o índice da posição da entidade.
     */
    @Override
